...
public class CommandFactory {
	...
	private Logger logger = LogManager.getLogger(CommandFactory.class);
	...
	public static enum Type {
		ACCEPT_ALERT_COMMAND, ACTIVATE_COMMAND, ASSERT_COMMAND, ASSIGN_COMMAND, AUTHENTICATE_COMMAND, CLICK_COMMAND,
		DELAY_COMMAND, DISMISS_ALERT_COMMAND, DRAG_FROM_COMMAND, DROP_TO_COMMAND, IMPLICIT_WAIT_COMMAND_TYPE,
		BACKWARD_HIST_NAV_COMMAND_TYPE, FORWARD_HIST_NAV_COMMAND_TYPE, OPEN_COMMAND, READVALUE_COMMAND,
		READSTATE_COMMAND, REFRESH_COMMAND, SELECT_OPTION_COMMAND, SWITCH_FRAME_COMMAND, SWITCH_WINDOW_COMMAND,
		SWITCH_DEFULT_CONTENT_COMMAND, WRITE_COMMAND, WRITE_PWD_COMMAND, SELECT_STATUS
	}
